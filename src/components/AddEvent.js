    ...
    <div className="fixed inset-x-14 inset-y-5 bg-black  bg-opacity-20 backdrop-blur-sm">
      <div className=" flex justify-center items-center">
        <div className=" w-4/5 flex-col items-center">
          <h1 className="text-black text-2xl font-bold mb-5">Add Event</h1>
          ...
          <div>
            <div className="flex flex-col">
              ...
              <label className="text-black">Event Date</label>
              ...
              />
              <label className="text-black">Event Time</label>
              ...
              />
              <label className="text-black">Event Description</label>
              ...
              />
              <label className="text-black">Event Organiser</label>
              ...
              />
              <label className="text-black">Event Link</label>
